...
- `examples/multilevel_gaze_mediation_simulation_recovery_contract.py` materializes weak, moderate, and strong known-truth design scenarios without faking a sampler run.
